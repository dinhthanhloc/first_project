				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							<li><a class="dropdown-item" href="<%=url%>/sanpham-main/sneaker.jsp">Sneaker</a></li>
							<li><a class="dropdown-item" href="<%=url%>/sanpham-main/soccer.jsp">Soccer Shoes</a></li>
							<li><a class="dropdown-item" href="<%=url%>/sanpham-main/running.jsp">Running Shoes</a></li>
							<li><a class="dropdown-item" href="<%=url%>/sanpham-main/sandals.jsp">Sandal</a></li>
					...
					<ul>
						<li><a href="<%=url%>/sanpham-main/nike-main.jsp"
							...
							<ul class="dropdown" id="dropdown">
								<li><a href="<%=url%>/sanpham-extra/nike-af1.jsp">Air Force 1</a></li>
								<li><a href="<%=url%>/sanpham-extra/nike-fd1.jsp">Air Jordan 1</a></li>
								<li><a href="<%=url%>/sanpham-extra/nike-air.jsp">Air Max</a></li>
							</ul></li>
						...
						<li><a href="<%=url%>/sanpham-main/new-balance-main.jsp"
							...
							<ul class="dropdown" id="dropdown">
								<li><a href="<%=url%>/sanpham-extra/new-balance-sneaker.jsp">Sneaker</a></li>
								<li><a href="<%=url%>/sanpham-extra/new-balance-soccer.jsp">Soccer</a></li>
								<li><a href="<%=url%>/sanpham-extra/new-balance-running.jsp">Running</a></li>
							</ul></li>
						...
						<li><a href="<%=url%>/sanpham-main/vans-main.jsp"
							...
							<ul class="dropdown" id="dropdown">
								<li><a href="<%=url%>/sanpham-extra/vans-old-skool.jsp">Vans Old Skool</a></li>
								<li><a href="<%=url%>/sanpham-extra/vans-authentic.jsp">Vans Authentic</a></li>
								<li><a href="<%=url%>/sanpham-extra/vans-sk8-hi.jsp">Vans Sk8-Hi</a></li>
							</ul></li>
						<li><a href="<%=url%>/sanpham-main/zocker-main.jsp"
							class="list-group-item list-group-item-action">Zocker</a>
							<ul class="dropdown" id="dropdown">
								<li><a href="<%=url%>/sanpham-extra/zocker-inpire.jsp">Zocker Inspire</a></li>
								<li><a href="<%=url%>/sanpham-extra/zocker-inpire-pro.jsp">Zocker Inspire Pro</a></li>
								<li><a href="<%=url%>/sanpham-extra/zocker-pioneer.jsp">Zocker Pioneer</a></li>
								<li><a href="<%=url%>/sanpham-extra/zocker-space.jsp">Zocker Space</a></li>
								<li><a href="<%=url%>/sanpham-extra/zocker-1902.jsp">Zocker 1902</a></li>
							</ul></li>
						<li><a href="<%=url%>/sanpham-main/kamito-main.jsp"
							class="list-group-item list-group-item-action">Kamito</a>
							<ul class="dropdown" id="dropdown">
								<li><a href="<%=url%>/sanpham-extra/kamito-nhan-tao.jsp">Cỏ Nhân Tạo</a></li>
								<li><a href="<%=url%>/sanpham-extra/kamito-tu-nhie.jsp">Cỏ tự nhiên</a></li>
						...
						<li><a href="<%=url%>/sanpham-main/mitre-main.jsp"
							...
							<ul class="dropdown" id="dropdown">
								<li><a href="<%=url%>/sanpham-extra/mitre-nhan-tao.jsp">Cỏ Nhân Tạo</a></li>
								<li><a href="<%=url%>/sanpham-extra/mitre-tu-nhie.jsp">Cỏ tự nhiên</a></li>
							</ul></li>
					</ul>
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url%>/khach-hang?action=id-shoes&id-shoes=<%=list.get(i).getMa_giay()%>"><img class="card-img-top" id="img-shoes"
								src="<%=list.get(i).getLink_hinh_anh()%>"></a>
							<div class="card-body">
								<h4 class="card-title">
									<a href="<%=url%>/khach-hang?action=id-shoes&id-shoes=<%=list.get(i).getMa_giay()%>"><%=list.get(i).getTen_giay()%></a>
								</h4>
