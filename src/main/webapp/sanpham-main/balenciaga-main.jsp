	...
	<div id="container">
		<div class="row">
			...
			<div class="col-lg-10">
				...
				<%
				String condition = "hang_giay = 'Balenciaga'";
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a
								href="<%=url%>/khach-hang?action=buy-shoes&id-shoes=<%=list.get(i).getMa_giay()%>"><img
								class="card-img-top" id="img-shoes"
								src="<%=list.get(i).getLink_hinh_anh()%>"></a>
							<div class="card-body">
								<h4 class="card-title">
									<a
										href="<%=url%>/khach-hang?action=id-shoes&id-shoes=<%=list.get(i).getMa_giay()%>"><%=list.get(i).getTen_giay()%></a>
								</h4>
