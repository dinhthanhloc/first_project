	...
	<nav class="navbar navbar-expand-lg">
		<div class="container-fluid">
			<a class="" href="<%=url%>/index.jsp"> <img
				src="<%=url%>/img/logo.png" alt="Bootstrap" height="55px">
			</a>
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu">
							...
							<li><a class="dropdown-item" href="#">Soccer shoes</a></li>
	...
	<div id="container">
		<div class="row">
			...
			<div class="col-lg-10">
				...
				<%
				String condition = "hang_giay = 'New Balance'";
				ArrayList<san_pham> list = DAOsanpham.getInstance().selectCondition(condition);
				if (list.size() == 0) {
				%>
				<h2 class="text-color">Sản phẩm đang được cập nhập</h2>
				<%
				} else {
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 mb-4">
						<div class="card h-100">
							<a href="<%=url%>/khach-hang?action=buy-shoes&id-shoes=<%=list.get(i).getMa_giay()%>"><img class="card-img-top" id="img-shoes"
